    ...
    <div className="flex h-full w-full flex-col overflow-hidden bg-background/50 p-4 text-foreground">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-border/40">
        <div className="flex items-center gap-3">
          <div className="flex size-11 items-center justify-center rounded-2xl overflow-hidden border border-border/40 shadow-sm p-0.5">
            <img src="/catmusic.png" alt="CatMusic" className="w-full h-full object-contain" />
          </div>
          <div>
