  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex size-10 items-center justify-center rounded-none overflow-hidden shadow-md transition-all ${
          !activeView || activeView === 'chat'
            ? 'scale-105 ring-2 ring-primary ring-offset-1 ring-offset-background'
            : 'opacity-80 hover:opacity-100 hover:scale-105'
        }`}
      >
        <img src="/catchat.png" alt="CatChat Logo" className="w-full h-full object-cover rounded-none" />
      </button>
