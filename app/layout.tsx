...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-background thin-scroll" suppressHydrationWarning>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(()=>{try{const t=localStorage.getItem('cz-theme')||'catchat';const dark=['dark','midnight','forest','coffee','cyber','catchat','orca','liquid-glass'];document.documentElement.setAttribute('data-theme',t);document.documentElement.classList.add(dark.includes(t)?'dark':'light');document.documentElement.classList.remove(dark.includes(t)?'light':'dark')}catch(e){}})();`,
          }}
        />
      </head>
